...
<div class="form-group {{ $errors->has('priority') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input max="5" min="1" class="form-control" name="priority" type="number" id="priority" value="{{ old('priority', optional($customer)->priority) }}" min="-2147483648" max="2147483647" required="true" placeholder="Enter priority here...">
